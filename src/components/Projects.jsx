...
const projects = [
  ...
  },
  {
    ...
    bgImage:
      "https://cdn.dribbble.com/userupload/15276181/file/original-a0f07373298e7c47fea247931c8b1684.jpg?resize=1504x1592&vertical=center",
  },
  {
    ...
    bgImage:
      "https://cdn.dribbble.com/userupload/16365106/file/original-971baeae128853b8185fc546fa611991.jpg?resize=1504x1504&vertical=center",
  },
];
    ...
    >
      ...
      <div className="grid gap-20">
        {projects.map((proj, idx) => (
          <div
            key={proj.title}
            className="relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 min-h-[400px]"
          >
            {/* Background Image */}
            <div
            ...
            <motion.div
              className="relative z-10 flex flex-col lg:flex-row text-white p-4 lg:p-8"
              initial="hidden"
              whileInView="visible"
